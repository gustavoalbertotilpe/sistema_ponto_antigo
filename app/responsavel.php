        ...
        <!--Div vazia!-->    
         ...
         <div class = "col-md-5">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="cadastror.php">CADASTRAR RESPONSAVEL</a>
                </li>
            </ul>
       </div>
    </div>
...
//Tabela de exebição do funcionarios cadastrados
    ...
    {
        $sql = $pdo->prepare("SELECT * FROM RESPONSAVEL WHERE  NOME LIKE '%".$_POST["busca"]."%' ORDER BY NOME ASC");
        $sql->execute();
        $sql = $sql->fetchAll(PDO::FETCH_ASSOC);
    }
    else 
    {
        $sql = $pdo->prepare("SELECT * FROM RESPONSAVEL ORDER BY NOME ASC");
        $sql->execute();
        $sql = $sql->fetchAll(PDO::FETCH_ASSOC);
    }
    ...
    else
    {
        ...
        $table.="<td><a href ='alterares.php?id=".$value["IDRESPONSAVEL"]."'>Editar</a></td>";
        $table.="</tr>";
